...
/**
 */
public class GrantAdminTestCase extends AbstractAffiliationTestCase {

    public void testGrantAdminByNick() throws Exception {
    ...
    public void testGrantAdminByJid() throws Exception {
        Room room = ConferenceTestUtils.findOrCreateRoom(conference, ROOM2_JID, "Room 2");
        Occupant occ1 = room.addOccupant(OCCUPANT1_JID, "nick");
        occ1.setRole(Role.Moderator);
        room.getAffiliations().add(OCCUPANT1_JID, Affiliation.Owner);
    ...
    public void testNonOwner() throws Exception {
        ...
        assertChangeNotAllowed("Nick 2", StanzaErrorCondition.NOT_ALLOWED, Affiliation.Admin, null);
    }
}
