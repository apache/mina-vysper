 ...
 */
public abstract class DelegatingStanzaBroker implements StanzaBroker {

    private final StanzaBroker delegate;

    public DelegatingStanzaBroker(StanzaBroker delegate) {
    ...
    public void writeToSession(Stanza stanza) {
        delegate.writeToSession(stanza);
    }
}
