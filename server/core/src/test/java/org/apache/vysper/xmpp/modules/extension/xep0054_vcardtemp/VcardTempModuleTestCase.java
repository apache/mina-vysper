...
/**
 */
public class VcardTempModuleTestCase {

    private VcardTempModule module = new VcardTempModule();
    ...
    public void getServerInfosFor() throws ServiceDiscoveryRequestException {
        ...
        Assert.assertEquals(NamespaceURIs.VCARD_TEMP, ((Feature)infoElements.get(0)).getVar());
    }
    ...
    public void addHandlerDictionaries() {
        ...
        Assert.assertEquals(NamespaceURIs.VCARD_TEMP, namespaceHandlerDictionary.getNamespaceURI());
    }
}
