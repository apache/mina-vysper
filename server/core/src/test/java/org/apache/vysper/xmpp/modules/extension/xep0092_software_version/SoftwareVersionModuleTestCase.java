...
/**
 */
public class SoftwareVersionModuleTestCase {

    private SoftwareVersionModule module = new SoftwareVersionModule();
    ...
    public void getServerInfosFor() throws ServiceDiscoveryRequestException {
        ...
        Assert.assertEquals(NamespaceURIs.JABBER_IQ_VERSION, ((Feature)infoElements.get(0)).getVar());
    }
    ...
    public void addHandlerDictionaries() {
        ...
        Assert.assertEquals(NamespaceURIs.JABBER_IQ_VERSION, namespaceHandlerDictionary.getNamespaceURI());
    }
}
